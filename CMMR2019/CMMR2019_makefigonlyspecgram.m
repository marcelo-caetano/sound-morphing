function CMMR2019_makefigonlyspecgram(magspec,timefr,freqfft,tmin,tmax,freqmin,freqmax,xlbl,ylbl,ttl,ext,savpath)
...
% % Downsample data
% timefr = timefr(1:2:end);
% freqfft = freqfft(1:2:end);
% magspec = magspec(1:2:end,1:2:end);

% Spectrogram
mesh1 = mesh(timefr,freqfft,magspec,'Parent',axes1);
% Frequency peaks of sinusoidal analysis
% plot(timefr,freqpart,'.','Color',peakcolor,'MarkerSize',6);
% mesh1.EdgeLighting = 'flat';
% mesh1.FaceLighting = 'none';
% mesh1.MeshStyle = 'row';
% mesh1.FaceColor = w;
% mesh1.EdgeColor = b;
% mesh1.LineWidth = lwidth;
set(mesh1,'LineWidth',lwidth);
