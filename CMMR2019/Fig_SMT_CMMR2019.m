...
% List all sounds in SDB
listsound = rsf(makepath({'Users','mcaetano','Documents','Sound Database',...
    'Vienna','Sounds'}),soundext);
...
% 100: Violin_f_C4.wav
% 104: Wagner_Tuba_nA_f_C3.wav
% 143: Tuba_oV_hA_2-120_ff_C3.wav
...
f0s1 = swipep(sound1,infos1.SampleRate,[75 500],1000/infos1.SampleRate,[],...
    1/20,0.5,0.2);
