function makefigonlywaveform(time,waveform,xmin,xmax,ymin,ymax,xlbl,ylbl,ttl,ext,savpath)
...
% % Create legend
% legend1 = legend([curve1 curve4 curve2 curve3 line2(1)],{'Magnitude','Parabola','Samples','Estimation','Bin'});
