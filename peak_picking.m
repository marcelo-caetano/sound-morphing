...
%   [INDEX] = PEAK_PICKING(MAG) returns a vector INDEX with the
...
% index(count) = [false(1,1) ; mag(2:end-1,count) > mag(1:end-2,count) & mag(2:end-1,count) > mag(3:end,count) ; false(1,1)];
